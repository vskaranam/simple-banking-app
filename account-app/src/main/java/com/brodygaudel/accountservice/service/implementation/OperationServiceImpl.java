...
public class OperationServiceImpl implements OperationService {
    ...
    @Transactional
    @Override
    public CreditDTO credit(CreditDTO creditDTO) throws AccountNotFoundException, BalanceNotSufficientException, AccountNotActivatedException {
        log.info("In credit() :");
...
//                .build();
    ...
    @Transactional
    @Override
    public DebitDTO debit(DebitDTO debitDTO) throws AccountNotFoundException, BalanceNotSufficientException, AccountNotActivatedException {
        log.info("In debit() :");
